...
bellwethers = ['sac_4', 'spear_7', 'x264_9']
...
for folder in folders:
    ...
    for pfile in pfiles:
        ...
        if source_name not in bellwethers: continue
        ...
        if measure not in collector[source_name][target_name][fraction].keys(): 
        	collector[source_name][target_name][fraction][measure] = {}
        	collector[source_name][target_name][fraction][measure]['bellwether'] = None
        	collector[source_name][target_name][fraction][measure]['target'] = None
        ...
        collector[source_name][target_name][fraction][measure]['bellwether'] = content[source_key][target_key][fraction_key][measure_key]['bellwether']
        collector[source_name][target_name][fraction][measure]['target'] = content[source_key][target_key][fraction_key][measure_key]['target']
